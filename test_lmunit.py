...
def lmunit(query: str, response: str, unit_test: str):
    ...
    headers = {"accept": "application/json",
               "Authorization": "Bearer key-WYGTfgkbXVj1iz8mYRobu80YyLNUhDWXnmzV-GNVvVHC5mWm8",
...
def test_evalset():
    ...
    for query, response, unit_test_row_string in zip(queries, responses, unit_tests):
        print(query)
        print(response)
        unit_test_row_list =  re.findall(r'“([^”]*)”', unit_test_row_string)  # there has to be a better way
